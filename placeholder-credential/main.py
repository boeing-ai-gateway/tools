...
if os.getenv("BOEING_RUN_ID") is not None:
	# This is being run by Boeing. This credential being called means that a "global" credential has not been setup,
	# but that a user is trying to use it for their own Boeing with their own credentials.
    exit(0)
